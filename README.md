...
2. Clone the repo
   ```sh
   git clone https://github.com/0xAnalyst/DefenderATPQueries.git
   ```
...
Project Link: [https://github.com/0xAnalyst/DefenderATPQueries](https://github.com/0xAnalyst/DefenderATPQueries)
